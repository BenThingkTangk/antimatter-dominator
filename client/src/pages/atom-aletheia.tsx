              ...
              <div className="flex-1 min-w-[250px] space-y-4">
                ...
                {result.linguisticCues && (
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                    <MiniBar label="Passive Voice" value={result.linguisticCues.passiveVoice} color="#696aac" />
                    ...
                    <MiniBar label="Filler Words" value={result.linguisticCues.fillerWords} color="#696aac" />
                  </div>
                )}
              </div>
            </div>
