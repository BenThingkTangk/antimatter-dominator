            ...
            {generatePitch.isPending ? (
              ...
              <>
                ...
                {activeResult.alternatives?.length > 0 && (
                  <div className="rounded-xl bg-black/40 backdrop-blur-md border border-white/[0.07] p-5">
                    <p className="text-[11px] text-white/40 uppercase tracking-wider font-medium mb-3">Alternative Approaches <span className="text-teal-400/50">· click to generate full pitch</span></p>
                    <div className="space-y-2">
                      {activeResult.alternatives.map((alt, i) => (
                        <div key={i}
                          className="group rounded-lg bg-white/[0.02] border border-white/[0.05] p-3 hover:bg-teal-500/[0.06] hover:border-teal-500/25 transition-all cursor-pointer"
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-center justify-between mb-1.5">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-[10px] text-teal-400/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-0.5">
